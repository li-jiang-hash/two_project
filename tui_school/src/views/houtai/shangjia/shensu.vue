  ...
  <div class="pad20">
    <el-card class="box-card">
      ...
      <el-table :data="tableData" stripe size="medium" style="width: 100%" :border="true">
        ...
        <el-table-column prop="businessId" label="商家店名" align="center">
        </el-table-column>
        <el-table-column
          prop="appealTime"
          label="申请时间"
        ...
        <el-table-column prop="info" label="申诉内容" align="center"> </el-table-column>
        <el-table-column
          header-align="center"
          align="center"
          prop="status"
      ...
      <el-dialog title="驳回" :visible.sync="rejectDialogVisible" width="50%">
        <span> 确定要驳回吗？ </span>
...
export default {
  ...
  methods: {
    ...
    pass(row) {
      ...
      var id = row.id;
      this.$http
        .post("/syssystem/b-appeal/tongguo?id=" + id + "&status=1")
        .then(function (result) {
          if (result.data.code === 2000) {
            that.$message.success(result.data.msg);
            that.init();
