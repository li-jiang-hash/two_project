    ...
    <el-dialog
        ...
        <el-form :model="formData" :rules="rules" ref="formData" label-width="100px">
            <el-form-item label="广告图片:" prop="imageUrl">
                <div>
                    <el-upload
                            ...
                            >
                        <img style="height: 50px;width: 200px" v-if="formData.imageUrl" v-model="formData.imageUrl" :src="formData.imageUrl" class="avatar" alt="">
            ...
            <el-form-item label="广告排序:" prop="sort">
                <el-input-number style="width: 300px;" v-model="formData.sort"
        ...
        methods: {
            ...
            submitForm() {
                ...
                this.$refs.formData.validate((valid)=>{
                    if (valid){
                        this.$http.post("/home/banner/addBanner",this.formData).then(function (resp) {
