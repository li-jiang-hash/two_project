<template>
    <div class="banner">
        ...
        <!--<router-view/>-->
        <y-class-block :height="height"/><!--classList="classList"--> <!--:height="height" :classList="classList"-->
    </div>
</template>
<script>
    ...
    export default {
        ...
        props: {
            data: {
                ...
                default:()=>[
                    {
                    'advImg':'http://static.roncoos.com/os/11.jpg',
                    'advUrl':'http://www.baidu.com',
                    'advTitle':'1',
                    'advTarget':'_blank'
                    },
                    {
                    'advImg':'http://static.roncoos.com/os/12.jpg',
                    'advUrl':'http://www.baidu.com',
                    'advTitle':'1',
                    'advTarget':'_blank'
                    },{
                    'advImg':require('@/assets/image/banner.jpg'),
                    'advUrl':'http://www.baidu.com',
                    'advTitle':'1',
                    'advTarget':'_blank'
                    },
