                                ...
                                <div data-v-1ee14d65="" style="height: 420px;margin: auto">
                                    ...
                                    <div data-v-1ee14d65="" class="remark" style="margin-top: 23px;padding-left: 75px">
                                        <el-form ref="form" :model="payForm">
                                            <label data-v-1ee14d65="" style="font-family: 幼圆;font-size: 15px">请选择购买数量:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <el-input-number size="small" :min="1" :max="stockNum"
                                                             style="margin-top: 5px"
                                                             v-model="payForm.num" @change="handleChange"
                                                             label="描述文字"></el-input-number>
                                            <span style="font-size: 13px;margin-left: 20px;font-family: 幼圆">
                                                {{classData.unit.unitname}}
                                            ...
                                            <el-link type="primary"
                                                     href="http://localhost:8080/geRenCenter"
    ...
    export default {
        ...
        methods: {
            ...
            weixinpay() {
                ...
                this.payForm.bid = this.classData.businessInfo.id
            ...
            changeShouCang() {
                ...
                this.$http.post("commodity/goods/changeCollectionStatus/" + this.$route.params.id + "/" + status).then(res => {
                    if (res.data.code === 2000) {
