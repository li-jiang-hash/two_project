<template>
  <div class="right_window">
    <div class="iconfont right_item show_xcx" @click.stop="hideEwm = false" @mouseenter="hideEwm = false" @mouseleave="hideEwm = true" v-if="webInfo && webInfo.weixinXcx">
      &#xe619;
      <div class="xcx_box" v-if="webInfo && webInfo.weixinXcx && !hideEwm">
        <div class="ewm_box">
          <img class="ewm_img" src="../assets/image/weixin.jpg" alt="">
          <p>关注TUI微信</p>
          <p>学习更高兴!</p>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      webInfo: {
        weixinXcx:"http://static-dev.roncoo.com/system/d1abbf37031a470dab1ce7b2ca641d55.jpg",
        isShowService:true,
        service1:907125112,
        service2:1430930278,
        service3:178288921,
