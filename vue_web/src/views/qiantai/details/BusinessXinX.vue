<template>
    <div class="courselist_page">
        ...
        <div>
            ...
            <div style="font-size: 20px;margin-left: 120px;margin-top: -50px;display: block;color: red">{{business.sname}}</div>
        </div>
        <!-- 右边通过v-for循环展示出的内容 -->
        ...
        methods:{
            ...
            tiaozhuan(gid){
                ...
                if(token && this.shenfen==="BUSINESS_PHONE"){
                    ...
                    this.$router.push({name:'DetailId',params: {id:gid}})
                } else {
            ...
            inintCourse(){
                var that = this
                this.$http.get(`/commodity/goods/findGoodsByBid/${this.pageObj.pageCurrent}/${this.pageObj.pageSize}/${this.bid}`).then(function (resp) {
