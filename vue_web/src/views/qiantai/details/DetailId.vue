        ...
        <div class=" detail_info detail_box clearfix">
            <div class="layout_left">
                <ul class="course_tab clearfix">
                    ...
                    <li v-if="hasBuy===true" :class="{on: tab === 'big'}"><a href="javascript:" @click="changeComments('big')">我的评论</a></li>
                    <el-button v-if="hasBuy===true"   type="primary" style="float: right;margin-right: 20px;margin-top: 15px" @click="addComment">添加评论</el-button>
                </ul>
                <!--商品评论-->
                ...
                <div class="content_info" v-if="tab === 'big'">
                    <div v-for="item in mycomments">
                        ...
                        <div style="width: 790px;margin-top: 15px;margin-left: 69px;">
                            <div style="font-family: 幼圆;font-size: 15px;margin-bottom: 25px">
                                {{item.info}}
                                <div style="font-size: 20px;font-family: 幼圆;float: right;margin-top: -20px;width: 124px">
            ...
            <el-dialog
                ...
                <span>
                    <span style="float: left"> 我的评分:</span><el-rate style="float: left;margin-left: 50px"
                                                                    v-model="editData.level"></el-rate>
                    <el-input
                    ...
                    <el-upload
                        ...
                        <img v-if="editData.imgs[0]" v-model="editData.imgs[0]" :src="editData.imgs[0]"
                             class="avatar" alt="">
                    ...
                    <el-upload
                            ...
                            :before-upload="beforeAvatarUpload">
                            <img v-if="editData.imgs[1]" v-model="editData.imgs[1]" :src="editData.imgs[1]"
                                 class="avatar" alt="">
                            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                    </el-upload>
                    <el-upload
                            ...
                            :before-upload="beforeAvatarUpload">
                                <img v-if="editData.imgs[2]" v-model="editData.imgs[2]" :src="editData.imgs[2]"
                                     class="avatar" alt="">
                                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                    </el-upload>
                    <div style="height: 200px"></div>
                    <el-link @click="deleteImg(0)" icon="el-icon-delete" style="float: left;margin-right: 173px;margin-left: 64px">删除</el-link>
                    <el-link @click="deleteImg(1)" icon="el-icon-delete" style="float: left;margin-right: 173px;">删除</el-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getMyComments() {
                this.$http.get("user/comment/findMyComment/" + this.$route.params.id + "/" + this.pageCurrent + "/" + this.pageSize).then(res => {
                    if (res.data.code === 2000) {
            ...
            getComments() {
                this.$http.get("user/comment/findComment/" + this.$route.params.id + "/" + this.pageCurrent + "/" + this.pageSize).then(res => {
                    if (res.data.code === 2000) {
