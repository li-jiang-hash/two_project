	...
	<div class="login_page">
				...
				<div :class="{login_form: true, rotate: tab == 2}">
					...
					<div class="form_body r180" v-if="tabp == 2">
						<form action="" @submit="regSubmit">
							...
							<div class="phone_yzm">
								<input type="text" name="code" placeholder="请输入手机验证码" class="phone" v-model="pobj.code"
									maxlength="6">
								<button class="yzm_btn" type="button" :disabled="disabled"
									@click="getCode">{{txt}}</button>
							</div>
							...
							<div class="mgt20 font_14">
								...
								<label for="tonyi">我已经阅读并同意</label><a href="jvascript:" class="c_blue"
		...
		<div class="login_footer">
			...
			<p>
				...
				<span>&nbsp;|&nbsp;</span>
				<a :href="'http://www.beian.gov.cn/portal/index'" target="_blank" v-if="service.prn"
					class="lingke_link"><img src="@/assets/image/prn_icon.png" class="prn_icon"
						alt="">&nbsp;{{service.prn}}</a>
			</p>
		</div>
	</div>
	...
	export default {
		...
		methods: {
			...
			regSubmit: function(e) {
				...
				if (!(/^1[3|4|5|8|7][0-9]\d{4,8}$/.test(this.pobj.mobile.trim())) || this.pobj.mobile.trim().length !==
					11) {
