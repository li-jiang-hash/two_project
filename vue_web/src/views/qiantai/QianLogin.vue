<template>
    <div class="login_page">
                ...
                <div  :class="{login_form: true, rotate: tab == 2}">
                    ...
                    <div class="form_body" v-if="tabp == 1">
                        <form action="" @submit="loginSubmit" >
                            ...
                            <input type="password" v-model="obj.qianPassword" placeholder="6-20位密码，可用数字/字母/符号组合">
        ...
        <div class="login_footer">
            ...
            <p>
                <a href="http://www.doityun.com/" target="_blank" class="lingke_link">TUI-教育提供计算服务</a>
                <span>&nbsp;|&nbsp;</span>
    ...
    export default {
        ...
        methods: {
            ...
            getCode () {
                ...
                //通过手机号获取验证码
                this.$http.post('/user/noteByPhone/${this.pobj.mobile}').then(function (result) {
            ...
            loginSubmit (e) {
                ...
                var that=this;
                this.subState = true;
                this.$http.post("/sso/admin/qianLogin",this.obj).then(function (resp) {
                    if (resp.data.code===2000){
                        that.subState = false;
                        that.$message.success(resp.data.msg);
                        sessionStorage.setItem("homeToken", resp.data.result.homeToken);
            ...
            regSubmit: function (e) {
                ...
                this.$http.post(`/student/member/installMember/${this.pobj.mobile}/${this.pobj.qianPassword}`).then(function (resp) {
                    if (resp.data.code===2000){
                        that.$message.success(resp.data.msg);
                        that.changetab(1);
                        that.pobj={};
